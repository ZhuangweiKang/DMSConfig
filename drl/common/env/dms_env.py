...
class Simulator:
    def __init__(self, model_path):
        self.predictors = {}
        state_meta = pd.read_csv('../../../benchmark/meta/state_meta.csv')
...
class DMSConfigEnv(gym.Env):
    def __init__(self, seed, model_path, latency_bound):
        act_meta = pd.read_csv('../../../benchmark/meta/config_meta.csv')
        state_meta = pd.read_csv('../../../benchmark/meta/state_meta.csv')

        self.act_names = act_meta['name'].tolist()
        ...
        self.simulator = Simulator(model_path)
