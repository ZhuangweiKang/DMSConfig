import numpy as np
from ddpg.ring_buffer import RingBuffer
...
class PriMemory(object):  # stored as ( s, a, r, s_ ) in SumTree
    """
    ...
    def sample(self, batch_size):
        ...
        b_idx, ISWeights = np.empty((batch_size,), dtype=np.int32), np.empty((batch_size, 1))
        b_memory = []
