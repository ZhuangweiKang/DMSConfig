...
from tuners.common import plot_util
...
def plot_results(dirs, num_timesteps=10e6, xaxis=X_TIMESTEPS, yaxis=Y_REWARD, title='', split_fn=split_by_task):
    ...
    plot_util.plot_results(results, xy_fn=lambda r: ts2xy(r['monitor'], xaxis, yaxis), average_group=True, resample=int(2*1e4))
...
def main():
    ...
    parser.add_argument('--dirs', help='List of log directories', nargs = '*', default=['./logs'])
    parser.add_argument('--num_timesteps', type=int, default=int(2*1e4))
    parser.add_argument('--xaxis', help = 'Varible on X-axis', default = X_TIMESTEPS)
    parser.add_argument('--yaxis', help = 'Varible on Y-axis', default = Y_REWARD)
    parser.add_argument('--task_name', help = 'Title of plot', default = 'DDPG')
